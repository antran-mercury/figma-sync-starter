# AI Init Prompt — figma-sync-starter
Generated: 2026-04-10

> **How to use**: Copy this entire file and paste it into your AI assistant (Claude, ChatGPT, GitHub Copilot, etc.).
> The context section below pre-answers the clarifying questions so the AI can start implementing immediately.
...
*The following answers are derived from the project configuration. The AI should use these instead of asking clarifying questions.*

### 1. Repository & Figma

| Field | Value |
| ----- | ----- |
| Repository | `antran-mercury/figma-sync-starter` |
| Figma File URL | ⚠️  [TODO: set FIGMA_FILE_URL in .env] |
| Node IDs in scope | `⚠️  [TODO: set FIGMA_NODE_IDS in .env or framesInScope in figma/figma.config.json]` |

### 2. Stack

| Field | Value |
| ----- | ----- |
| Framework | ⚠️  [TODO: set project.stack.framework in figma-mapping.json — e.g. Next.js, React, Vue] |
| Language | Node.js (ESM) |
| Styling | ⚠️  [TODO: set project.stack.styling — e.g. Tailwind, CSS Modules, styled-components] |
...
### 5. Behavior Notes (from `.prompts/note_behavior/`)

*These describe the latest design-team behavior specifications for each Figma node.*
...
> **Next step**: The AI should now proceed with the architecture proposal and code output
> as described in the spec above — without asking the answered questions again.
